...
import HomePageFloatingVoiceAssistant from '@/components/voice/HomePageFloatingVoiceAssistant';
...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-background overflow-hidden">
      ...
      {/* Enhanced Home Page Floating Voice Assistant */}
      <HomePageFloatingVoiceAssistant />
