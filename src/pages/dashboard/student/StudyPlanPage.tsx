...
import { Calendar, BookOpen, Settings, Target, TrendingUp, Brain, Clock, ChevronLeft } from 'lucide-react';
    ...
    <SidebarLayout>
      <div className="container py-6 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mt-4 mb-6">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Dynamic Study Plan</h1>
            <p className="text-gray-600 dark:text-gray-400 mt-1">
              Personalized adaptive learning path for NEET 2026
            </p>
          </div>
