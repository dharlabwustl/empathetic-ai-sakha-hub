    ...
    >
      <div className="mb-8">
        <Button
          variant="outline"
          size="sm"
          className="mb-5 flex items-center gap-1 shadow-sm hover:shadow transition-all"
        ...
        <Card className="mb-7 border border-gray-100 dark:border-gray-800 rounded-xl shadow-md hover:shadow-lg transition-all duration-300">
            ...
            <div className="flex flex-wrap items-center justify-between gap-5">
              <div>
                ...
                <CardDescription className="mt-3 flex flex-wrap gap-2">
                  <Badge variant="outline" className="bg-purple-100 text-purple-800 border-purple-200 dark:bg-purple-900/30 dark:text-purple-300 dark:border-purple-800 px-3 py-0.5 rounded-full text-xs font-medium">
                    {concept.subject}
                  </Badge>
                  <Badge variant="outline" className="bg-violet-100 text-violet-800 border-violet-200 dark:bg-violet-900/30 dark:text-violet-300 dark:border-violet-800 px-3 py-0.5 rounded-full text-xs font-medium">
                    {concept.chapter}
                  </Badge>
          ...
          <CardContent className="pt-5">
            <div className="mb-5">
              <h3 className="font-medium mb-3 text-gray-700 dark:text-gray-300">Progress</h3>
            ...
            <p className="text-muted-foreground text-base">{concept.description}</p>
          </CardContent>
        </Card>
        ...
        <Tabs 
          ...
          className="space-y-5"
        >
          <TabsList className="w-full grid grid-cols-4 p-1.5 bg-gray-100/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-lg">
            <TabsTrigger value="learn" className="rounded-md py-3 text-sm font-medium">Learn</TabsTrigger>
            <TabsTrigger value="practice" className="rounded-md py-3 text-sm font-medium">Practice</TabsTrigger>
            <TabsTrigger value="formula" className={concept.hasFormulas ? "rounded-md py-3 text-sm font-medium" : "hidden"}>
              Formula Lab
            </TabsTrigger>
            <TabsTrigger value="test" className="rounded-md py-3 text-sm font-medium">Test</TabsTrigger>
          </TabsList>
          
          <TabsContent value="learn" className="space-y-5 pt-2">
            <Card className="border border-gray-100 dark:border-gray-800 shadow-sm hover:shadow transition-all rounded-xl">
              <CardHeader className="pb-3 bg-gradient-to-r from-gray-50/50 to-white/50 dark:from-gray-900/50 dark:to-gray-800/50">
                <CardTitle className="text-lg font-bold">Summary</CardTitle>
              </CardHeader>
              <CardContent className="pt-5">
                <p className="text-gray-700 dark:text-gray-300 text-base">{concept.content.summary}</p>
                
                <h3 className="font-medium mt-7 mb-4 text-gray-800 dark:text-gray-200">Key Points</h3>
                ...
                <h3 className="font-medium mt-7 mb-4 text-gray-800 dark:text-gray-200">Examples</h3>
                <ul className="list-disc pl-5 space-y-3 text-gray-700 dark:text-gray-300">
          ...
          <TabsContent value="practice" className="space-y-5 pt-2">
            <Card className="rounded-xl shadow-sm hover:shadow transition-all">
              <CardHeader className="pb-3 bg-gradient-to-r from-gray-50/50 to-white/50 dark:from-gray-900/50 dark:to-gray-800/50">
                <CardTitle className="text-lg font-bold">Practice Questions</CardTitle>
              </CardHeader>
              <CardContent className="pt-5">
                <p className="text-muted-foreground mb-5">Solve these practice questions to strengthen your understanding of {concept.title}.</p>
                <div className="space-y-5">
                  <div className="border border-gray-100 dark:border-gray-800 p-5 rounded-lg shadow-sm">
                    <div className="font-medium mb-3 text-gray-800 dark:text-gray-200">Question 1</div>
                    ...
                    <Button className="mt-5 bg-blue-600 hover:bg-blue-700 text-white">View Solution</Button>
                  </div>
                  <div className="border border-gray-100 dark:border-gray-800 p-5 rounded-lg shadow-sm">
                    <div className="font-medium mb-3 text-gray-800 dark:text-gray-200">Question 2</div>
          ...
          <TabsContent value="formula" className="space-y-5 pt-2">
            <FormulaTabContent 
              conceptId={id || '1'} 
          ...
          <TabsContent value="test" className="space-y-5 pt-2">
            <Card className="rounded-xl shadow-sm hover:shadow transition-all">
              <CardHeader className="pb-3 bg-gradient-to-r from-gray-50/50 to-white/50 dark:from-gray-900/50 dark:to-gray-800/50">
                <CardTitle className="text-lg font-bold">Knowledge Assessment</CardTitle>
              </CardHeader>
              <CardContent className="pt-5">
                <p className="text-muted-foreground mb-5">Test your understanding of {concept.title} with this quick assessment.</p>
