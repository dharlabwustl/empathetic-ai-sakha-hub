...
const ProfilePageContent = () => {
  ...
  useEffect(() => {
    if (!loading && userProfile) {
      const welcomeMessage = `Welcome to your profile page, ${userProfile.name}. Here you can manage your personal details, subscription, and voice settings.`;
  ...
  const handleProfileImageUpload = (file: File) => {
    try {
      ...
      speak("Your profile image has been updated successfully.");
    } catch (error) {
      toast({
        title: "Error",
      ...
      speak("Failed to update your profile image. Please try again.");
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            <Card>
              ...
              <TabsContent value="voice" className="p-6">
                <div className="flex justify-between items-center mb-6">
                  <h2 className="text-2xl font-semibold">Voice Announcer Settings</h2>
                </div>
                <VoiceSettingsTab />
              </TabsContent>
            </Card>
