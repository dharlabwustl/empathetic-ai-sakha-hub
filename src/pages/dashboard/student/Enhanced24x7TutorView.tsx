...
import { Mic, MicOff, Volume2, VolumeX, MessageCircle, Search, Brain, Zap, Eye, BarChart3, ShoppingCart, Star, Sparkles } from 'lucide-react';
...
const Enhanced24x7TutorView: React.FC = () => {
  ...
  const handleFeatureSelect = (featureId: string) => {
    ...
    // Add system message about feature selection
    const systemMessage = {
      role: 'assistant',
