...
const DashboardLayout = ({
  ...
  const upcomingEvents = [
    { 
      ...
      time: 'Today, 4:00 PM', 
      type: 'exam' as const,
      url: '/dashboard/student/concepts/1'
    },
    { 
      title: 'Biology Revision', 
      time: 'Tomorrow, 9:00 AM', 
      type: 'task' as const,
      url: '/dashboard/student/concepts/2'
    }
  ];

  return (
    <div className={`min-h-screen bg-gradient-to-br from-sky-100/10 via-white to-violet-100/10 dark:from-sky-900/10 dark:via-gray-900 dark:to-violet-900/10 ${currentMood ? `mood-${currentMood.toLowerCase()}` : ''}`}>
