...
import { Bell, Calendar, Volume2, VolumeX } from "lucide-react";
  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <Button
          variant={settings.enabled ? "outline" : "outline"} 
          size="sm"
        ...
        >
          ...
          <span className="hidden sm:inline">{settings.enabled ? "Voice On" : "Voice Off"}</span>
        </Button>
