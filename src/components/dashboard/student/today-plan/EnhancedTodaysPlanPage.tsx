...
import TodaysPlanSmartSuggestions from './TodaysPlanSmartSuggestions';

const EnhancedTodaysPlanPage: React.FC = () => {
...
export default EnhancedTodaysPlanPage;
