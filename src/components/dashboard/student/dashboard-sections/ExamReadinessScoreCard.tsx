...
const ExamReadinessScoreCard: React.FC = () => {
  ...
  const readinessData = {
    ...
    weeklyGrowth: 4.2, // New weekly growth percentage
    weeklyGrowthTrend: "up", // up, down, stable
    subjectBreakdown: [
  ...
  return (
    ...
    >
      <AnimatedHighlight
        ...
        storageKey="has_seen_readiness_highlight"
      >
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-1">
                        <TrendingUp className={`h-3 w-3 ${
                          readinessData.weeklyGrowthTrend === 'up' ? 'text-green-600' :
                          readinessData.weeklyGrowthTrend === 'down' ? 'text-red-600 rotate-180' :
                          'text-gray-600'
                        }`} />
                        <p className={`font-bold text-sm ${
                          readinessData.weeklyGrowthTrend === 'up' ? 'text-green-700' :
                          readinessData.weeklyGrowthTrend === 'down' ? 'text-red-700' :
                          'text-gray-700'
                        }`}>
                          +{readinessData.weeklyGrowth}%
                        </p>
                      </div>
                    </div>
                  </div>
