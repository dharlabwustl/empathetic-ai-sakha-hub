...
const ExamGoalCard: React.FC<ExamGoalCardProps> = ({ currentMood, onMoodChange }) => {
  const examData = {
    ...
    timeProgress: 45, // Progress through preparation timeline
    studyHours: 1250,
    targetHours: 2000,
    subjects: [
  ...
  const studyProgress = (examData.studyHours / examData.targetHours) * 100;
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2">
            <div className="flex justify-between text-sm">
              ...
              <span className="font-medium">{examData.examReadinessScore}%</span>
            </div>
            <Progress value={examData.examReadinessScore} className="h-2" />
          </div>
          ...
          <div className="space-y-2">
            <div className="flex justify-between text-sm">
              ...
              <span className="font-medium">{examData.timeProgress}%</span>
            </div>
          ...
          <div className="space-y-2">
            <div className="flex justify-between text-sm">
              ...
              <span className="font-medium">{examData.studyHours}/{examData.targetHours}hrs</span>
            </div>
