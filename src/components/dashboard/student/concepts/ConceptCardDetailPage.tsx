...
// Replace the problematic imports with our custom icons
import { BookOpen, FileText, Lightbulb, ArrowLeft, Brain, BookMarked, MessageCircle, History } from 'lucide-react';
import { Cube, Formula } from '@/components/icons/custom-icons';
// ... keep existing code
import {
  Card,
  CardContent,
