...
import { Calculator, ArrowRight, Check, Upload, FileQuestion, Lightbulb } from 'lucide-react';
...
const FormulaTabContent = () => {
  ...
  // On initial load, generate a default question
  useEffect(() => {
    generateQuestion();
  }, []);
  ...
  return (
    <div className="space-y-6">
      <Card className="bg-white dark:bg-gray-950 overflow-hidden">
        <CardHeader>
          <div className="flex flex-wrap justify-between items-center gap-2">
            ...
            <Button onClick={goToFormulaLab} className="gap-2">
                ...
                <Card className="relative border-l-4 border-l-blue-600">
                  <CardHeader className="pb-2">
                    <div className="flex items-center justify-between">
                      <Badge variant={
                        activeQuestion.difficulty === 'easy' ? 'default' :
                        activeQuestion.difficulty === 'medium' ? 'secondary' : 'destructive'
                      }>
                        ...
                        >
                          <div className="flex items-center">
                            <Badge variant={
                              ...
                              q.difficulty === 'hard' ? 'destructive' : 'outline'
                            } className="mr-2">
