...
import { 
  ...
  ArrowRight, Layers, Calculator, FileText, BookOpenCheck
} from 'lucide-react';
...
export const ConceptCardDetail = () => {
  ...
  // Function to navigate to interactive cards
  const handleInteractiveCardsClick = () => {
    navigate(`/dashboard/student/concepts/${id}/interactive-cards`);
    toast({
      title: "Loading interactive cards",
      description: "Preparing interactive learning materials for this concept",
    });
  };

  // Function to navigate to exam cards
  const handleExamCardsClick = () => {
    navigate(`/dashboard/student/concepts/${id}/exam-cards`);
    toast({
      title: "Loading exam cards",
      description: "Preparing exam-focused materials for this concept",
    });
  };

  // Function to navigate to formula lab
  const handleFormulaLabClick = () => {
    navigate(`/dashboard/student/formula-practice-lab?conceptId=${id}`);
    toast({
      title: "Opening Formula Practice Lab",
      description: "Preparing formula practice for this concept",
    });
  };
  ...
  // Check if concept involves formulas (based on subject)
  const hasFormulas = ['physics', 'mathematics', 'chemistry'].includes(conceptCard.subject?.toLowerCase() || '');
      ...
      <div className="space-y-6">
        <TooltipProvider>
          <Tooltip>
            ...
            <TooltipContent>Return to concepts list</TooltipContent>
          </Tooltip>
        </TooltipProvider>
            ...
            {!conceptCard.completed && (
              <TooltipProvider>
                <Tooltip>
                  ...
                  <TooltipContent>Mark this concept as completed</TooltipContent>
                </Tooltip>
              </TooltipProvider>
            )}
          </div>
            ...
            <div className="mt-4 pt-4 border-t border-blue-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mt-3">
                <TooltipProvider>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Button variant="outline" className="justify-start bg-white" onClick={handleInteractiveCardsClick}>
                        <Brain className="mr-2 h-4 w-4 text-violet-500" />
                        <div className="text-left">
                          <span className="block text-sm">Interactive Cards</span>
                          <span className="block text-xs text-muted-foreground">Learn through interactive exercises</span>
                        </div>
                      </Button>
                    </TooltipTrigger>
                    <TooltipContent>Interactive learning cards for this concept</TooltipContent>
                  </Tooltip>
                </TooltipProvider>
                ...
                <TooltipProvider>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Button variant="outline" className="justify-start bg-white" onClick={handleExamCardsClick}>
                        <FileText className="mr-2 h-4 w-4 text-blue-500" />
                        <div className="text-left">
                          <span className="block text-sm">Exam Cards</span>
                          <span className="block text-xs text-muted-foreground">Exam-focused practice</span>
                        </div>
                      </Button>
                    </TooltipTrigger>
                    <TooltipContent>Exam-focused practice for this concept</TooltipContent>
                  </Tooltip>
                </TooltipProvider>
                ...
                {hasFormulas && (
                  <TooltipProvider>
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <Button variant="outline" className="justify-start bg-white" onClick={handleFormulaLabClick}>
                          <Calculator className="mr-2 h-4 w-4 text-green-500" />
                          <div className="text-left">
                            <span className="block text-sm">Formula Practice</span>
                            <span className="block text-xs text-muted-foreground">Practice with formulas</span>
                          </div>
                        </Button>
                      </TooltipTrigger>
                      <TooltipContent>Practice formulas related to this concept</TooltipContent>
                    </Tooltip>
                  </TooltipProvider>
                )}
              </div>
                ...
                <div className="flex justify-end space-x-2">
                  ...
                  <TooltipProvider>
                    <Tooltip>
                      ...
                      <TooltipContent>Save your notes</TooltipContent>
                    </Tooltip>
                  </TooltipProvider>
                </div>
              </div>
              ...
              <div>
                ...
                <TooltipProvider>
                  <Tooltip>
                    ...
                    <TooltipContent>Edit your notes</TooltipContent>
                  </Tooltip>
                </TooltipProvider>
              </div>
            ) : (
              <div className="text-center py-8">
                ...
                <TooltipProvider>
                  <Tooltip>
                    ...
                    <TooltipContent>Add notes for this concept</TooltipContent>
                  </Tooltip>
                </TooltipProvider>
              </div>
            )}
        ...
        <div className="flex justify-center mt-6">
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent>Begin studying this concept</TooltipContent>
            </Tooltip>
          </TooltipProvider>
        </div>
                    ...
                    <CardContent className="p-4">
                      ...
                      <TooltipProvider>
                        <Tooltip>
                          ...
                          <TooltipContent>View this related concept</TooltipContent>
                        </Tooltip>
                      </TooltipProvider>
                    </CardContent>
                  </Card>
