...
interface NEETOverviewSectionProps {
  title: string;
  subjects: NEETSubjectProgress[];
...
const NEETOverviewSection: React.FC<NEETOverviewSectionProps> = ({
  title,
  subjects,
  totalStudyTime,
  overallProgress,
  ...
  return (
    <div className="space-y-6 mb-8">
      ...
      <div className="flex justify-between items-center">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">NEET 2026 Preparation Progress</p>
          </div>
        </div>
        <div className="flex items-center gap-3">
          ...
          <div className="space-y-4">
            {subjects.map((subject, index) => (
              <motion.div
                ...
                className={`space-y-3 p-4 rounded-lg border ${getSubjectColor(subject.name)}`}
              >
                <div className="flex justify-between items-center">
                  <div className="flex items-center gap-3">
      ...
      {/* Smart AI Suggestions for NEET */}
      <Card className="bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 border-indigo-200 dark:border-indigo-800">
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            <Lightbulb className="h-5 w-5 text-amber-600" />
            Smart AI Suggestions for NEET {pageContext.charAt(0).toUpperCase() + pageContext.slice(1).replace('-', ' ')}
          </CardTitle>
        </CardHeader>
        <CardContent>
...
export default NEETOverviewSection;
