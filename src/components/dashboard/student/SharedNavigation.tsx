...
const SharedNavigation = () => {
  ...
  return (
    <TooltipProvider>
      <div className="p-3 bg-white/90 dark:bg-orange-950/90 backdrop-blur-sm rounded-xl shadow-sm border border-orange-100 dark:border-orange-800/30 sticky top-0 z-10 mb-6">
                ...
                <TooltipTrigger asChild>
                  ...
                  >
                    <Button
                      ...
                      size="sm"
                      className={`flex items-center gap-1 whitespace-nowrap text-xs md:text-sm ${isActive(tab.path) ? 'bg-orange-500 hover:bg-orange-600 text-white' : 'text-orange-700 hover:text-orange-600 dark:text-orange-300 dark:hover:text-orange-400'}`}
