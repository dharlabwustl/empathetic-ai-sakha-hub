...
const HomePageVoiceAssistant: React.FC<HomePageVoiceAssistantProps> = ({ 
  ...
  const getContextMessage = (path: string, lang: string) => {
    if (path === '/') {
      return "Welcome to PREP-zer, the world's first emotionally aware, hyper-personalized adaptive exam preparation platform. I'm Sakha AI, your learning assistant. Our platform adapts to your unique learning style and emotional state. How can I assist you today?";
    } else if (path.includes('/signup')) {
      return "Welcome to PREP-zer signup! I'm Sakha AI. You can use voice commands to fill in the form. Click on any field and then use the microphone button to speak. Would you like assistance with signing up?";
    } else if (path.includes('/free-trial')) {
      return "Welcome to your free trial of PREP-zer's emotionally intelligent exam platform. I'm Sakha AI, and I'll help you experience personalized learning paths tailored to your needs.";
