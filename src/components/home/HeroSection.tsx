    ...
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-purple-900/20 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-5xl mx-auto">
          ...
          {/* NEET 2026 Banner - Separate and Highlighted */}
          <motion.div
            initial={{ opacity: 0, y: -20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <div className="min-h-[80px] flex items-center justify-center">
              <motion.div
                ...
                className="bg-white/80 dark:bg-gray-800/80 rounded-xl p-4 backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50 shadow-lg max-w-md mx-auto"
              >
