...
import { Award, CheckCircle2, ArrowRight, Sparkles, Play } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <motion.button
        ...
        className="mb-4 bg-gradient-to-r from-pink-500 to-orange-500 hover:from-pink-600 hover:to-orange-600 text-white font-bold py-2 px-4 rounded-full flex items-center shadow-lg"
      ...
      >
        <Play className="mr-1 h-5 w-5 animate-pulse" />
        <span>NEET Live Now</span>
        <motion.span 
          className="ml-2 h-2 w-2 rounded-full bg-red-400"
          animate={{ 
            opacity: [1, 0.6, 1],
            scale: [1, 1.2, 1]
          }}
