...
import { Users, Brain, Calendar, Heart, Star } from 'lucide-react';
...
const KpiStats = () => {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-5 md:gap-6 lg:gap-8">
      <StatCard 
      ...
      {/* Removed Formula Practice Success card */}
