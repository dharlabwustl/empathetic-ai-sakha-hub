...
const Index = () => {
  ...
  useEffect(() => {
    ...
    const handleAssistantSpeakingEvent = (e: CustomEvent) => {
      setAssistantSpeaking(e.detail.speaking);
    };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-background overflow-hidden">
      ...
      {/* Floating Voice Assistant button with visual indicators */}
      <div className="fixed bottom-6 right-6 z-50">
        <motion.button
          className={`bg-gradient-to-r ${assistantSpeaking || assistantListening ? 'from-purple-700 to-indigo-700 animate-pulse' : 'from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700'} text-white rounded-full p-4 shadow-lg hover:shadow-xl flex items-center justify-center`}
        ...
        >
          ...
          <span className="ml-2 font-medium">
            {assistantSpeaking ? "Sakha is Speaking..." : 
