      ...
      <Container>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-300">Receive study plans tailored to your individual needs and learning style.</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-300">Get instant help and explanations from our AI tutor, available 24/7.</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-300">Monitor your progress and identify areas where you need to focus more.</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-300">Simulate exam conditions with our comprehensive mock tests.</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-300">Quickly review key concepts with our concise concept cards.</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-300">Memorize important information with our interactive flashcards.</p>
          </motion.div>
        </div>
      </Container>
    </section>
