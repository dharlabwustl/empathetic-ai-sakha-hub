...
import { Headphones, Mic, Brain, Users } from 'lucide-react';
...
const VoiceAssistant: React.FC = () => {
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Daily interactions</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Using voice features</p>
          </CardContent>
        </Card>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Voice Assistant Management</CardTitle>
        </CardHeader>
        <CardContent>
          <p>Manage voice recognition, speech synthesis, command processing, and multi-language voice interactions.</p>
        </CardContent>
      </Card>
    </div>
  );
