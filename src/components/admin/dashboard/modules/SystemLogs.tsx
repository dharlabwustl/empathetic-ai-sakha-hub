  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Warning messages</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">89,271</div>
      ...
      <Card>
        ...
        <CardContent>
          <p>Monitor system logs, error tracking, performance monitoring, and debugging tools for comprehensive system health management.</p>
        </CardContent>
      </Card>
    </div>
  );
