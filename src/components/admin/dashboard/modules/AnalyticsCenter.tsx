  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Collected daily</p>
          </CardContent>
        </Card>
      ...
      <Card>
        ...
        <CardContent>
          <p>Comprehensive analytics platform with custom dashboards, real-time reporting, and predictive insights.</p>
        </CardContent>
      </Card>
    </div>
  );
