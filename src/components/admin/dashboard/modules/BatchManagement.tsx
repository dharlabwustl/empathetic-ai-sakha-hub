...
import { UserCheck, Users, Calendar, Target } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Students in Batches</CardTitle>
      ...
      <Card>
        ...
        <CardContent>
          <p>Manage student batches, group assignments, batch-specific study plans, and collaborative learning activities.</p>
        </CardContent>
      </Card>
    </div>
  );
