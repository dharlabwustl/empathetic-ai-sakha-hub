...
export const mockSubjectsProgress: SubjectProgress[] = [
  {
    ...
    color: "#3b82f6", // blue
    topics: [
      { id: "t1", name: "Mechanics", progress: 85, status: "completed", masteryLevel: 85, lastPracticed: "2025-05-10" },
      { id: "t2", name: "Thermodynamics", progress: 78, status: "completed", masteryLevel: 78, lastPracticed: "2025-05-08" },
      { id: "t3", name: "Electromagnetism", progress: 65, status: "in-progress", masteryLevel: 65, lastPracticed: "2025-05-05" },
      { id: "t4", name: "Optics", progress: 45, status: "in-progress", masteryLevel: 45, lastPracticed: "2025-05-01" },
      { id: "t5", name: "Modern Physics", progress: 30, status: "in-progress", masteryLevel: 30, lastPracticed: "2025-04-28" }
    ],
    quizScores: [
  ...
  },
  {
    ...
    color: "#8b5cf6", // purple
    topics: [
      { id: "t6", name: "Algebra", progress: 90, status: "completed", masteryLevel: 90, lastPracticed: "2025-05-11" },
      { id: "t7", name: "Calculus", progress: 75, status: "completed", masteryLevel: 75, lastPracticed: "2025-05-09" },
      { id: "t8", name: "Trigonometry", progress: 60, status: "in-progress", masteryLevel: 60, lastPracticed: "2025-05-06" },
      { id: "t9", name: "Coordinate Geometry", progress: 40, status: "in-progress", masteryLevel: 40, lastPracticed: "2025-05-02" }
    ],
    quizScores: [
  ...
  },
  {
    ...
    color: "#10b981", // green
    topics: [
      { id: "t10", name: "Organic Chemistry", progress: 65, status: "completed", masteryLevel: 65, lastPracticed: "2025-05-08" },
      { id: "t11", name: "Inorganic Chemistry", progress: 40, status: "in-progress", masteryLevel: 40, lastPracticed: "2025-05-04" },
      { id: "t12", name: "Physical Chemistry", progress: 30, status: "in-progress", masteryLevel: 30, lastPracticed: "2025-04-30" }
    ],
    quizScores: [
  ...
  },
  {
    ...
    color: "#f43f5e", // red
    topics: [
      { id: "t13", name: "Cell Biology", progress: 70, status: "completed", masteryLevel: 70, lastPracticed: "2025-05-09" },
      { id: "t14", name: "Genetics", progress: 35, status: "in-progress", masteryLevel: 35, lastPracticed: "2025-05-03" },
      { id: "t15", name: "Human Physiology", progress: 25, status: "in-progress", masteryLevel: 25, lastPracticed: "2025-04-29" },
      { id: "t16", name: "Ecology", progress: 15, status: "not-started", masteryLevel: 15, lastPracticed: "2025-04-25" }
    ],
    quizScores: [
